...
MainWindowVM::MainWindowVM(QObject *parent)
	...
	, _config_storage_vm(std::make_unique<ConfigStorageAdapter>())
{
	...
	connect(this, &MainWindowVM::gameFolderChoosed, _config_storage_vm.get(), &ConfigStorageAdapter::save_game_folder);
